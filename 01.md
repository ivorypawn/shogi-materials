...
But before moving on to the next page, one more thing. "Brinkmate problem." This is considered as the brinkmate version of 詰将棋. However, please note that the sequences for brinkmate problems include not only checks but also threatmates.
...
In this video, I will quote some of the brinkmate problems included in this book, either verbatim or in my modified form. The quoted problems will be marked with this blue_book emoji.
 -->
---
<!-- _class: standout -->
# Variations
...
These lines are very close to brinkmate, and many other variations for Black can be considered. However, in my conclusion, Black can't achieve brinkmate.
