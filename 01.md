...
Maybe you are not so familiar with it. It is closer to the notation well used in Japan, but I find it less ambiguous / and with higher readability than the traditional style.
...
Black continues to attack by ☗桂'33. Then White has to cover the squares 21 and 22 simultaneously. The sacrifice ☖金'31 doesn't work. ☗金x ☖角x33+ ☗金'21#. So here ☖角x+ is forced. Black takes back.

Actually, this position is brinkmate, but have you considered ☖飛'92 and how to checkmate from here? If haven't, calculate again... OK? ☗角'22 ☖玉-21 ☗銀x12+ ☖玉x ☗香'13 ☖玉-21 ☗香-11+#.
 -->
...
First, we explore N-32+ on the board.
...
...(☖飛'92 は動かさない)
Up to this point, the sequence was the same as in Exercise 3.2. In Exercise 3.2, it was brinkmate. This time there is no mating line after ☖飛'92, but next ☗角'44 makes it brinkmate. White can't prevent the coming ☗金-32, discovered check shutting the rook.
