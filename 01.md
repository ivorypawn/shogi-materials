...
Maybe you are not so familiar with it. It is closer to the notation used in Japan, but I find it less ambiguous / and with higher readability than the Japanese style.
...
<!-- 
The position shown here is brinkmate, and the list is of possible replies by White. Please calculate checkmating lines after each move.
