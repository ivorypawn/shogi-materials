...
Please pause the video again to calculate whether or not each position is brinkmate. And if you determine that it is not brinkmate, which means White has a reply to avoid immediate mating line, consider whether Black can achieve brinkmate within a few moves.
...
It will be much sooner next time as I'm getting used to it, but it may take longer depending on my job starting next year.
